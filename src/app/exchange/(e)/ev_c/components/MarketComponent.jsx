                ...
                <Collapse in={open} className="col-span-12 text-white px-1">
...

                    {
                        market.runners && market.runners.map((runner, ii) => (
                            <div key={ii} className="col-span-12 grid grid-cols-12 items-center w-full border-b border-black/[0.2] hover:bg-gray-700" >
                                <div className="col-span-8 md:col-span-6 flex items-center justify-between ">
                                    <div className='flex items-center gap-x-1'>
                                        <InfoTwoToneIcon
                                            fontSize='smaller'
