        ...
        <div className="w-full ">
            ...
            >
                <Group
                    position="start"
                    onClick={onClick}
                    className="col-span-12 bg-[#5700A3] border-b border-black/[0.2]"
                >
                    <div className="flex flex-col w-full">
                        {/* Market name */}
                        <div className="flex items-center gap-x-2 w-full">
                            <p className="text-sm font-bold text-white px-1 py-2  ">
                                {open ? (
                                    <InfoTwoToneIcon fontSize="small" className="text-white" />
                                ) : (
                                    <InfoTwoToneIcon fontSize="small" className="text-white" />
                                )}
                                {market.marketName}
                            </p>
                            <p className="text-sm font-bold tracking-wider text-black bg-warning rounded">
                                <span>Cash Out</span>
                            </p>
                        </div>

                        {/* Cash Out and Matched section in flex with justify-between */}
                        <div className="flex justify-between items-center gap-x-1 w-full p-1 hidden">
                            <div className="flex items-center gap-x-1">
                                <p className={`${styling2.totalMatched}`}>Matched:</p>
                ...
                <Collapse in={open} className="col-span-12 text-white px-1">
                    ...
                    {market.runners &&
                        market.runners.map((runner, ii) => (
                            <div
                                key={ii}
                                className="col-span-12 grid grid-cols-11 md:grid-cols-12 items-center w-full border-b border-black/[0.2] hover:bg-gray-700"
                            >
                                        ...
                                        {isLineMarket ? (
                                            <>
                                                {selectedEventId === null && isLineMarket && (
                                                    <>
                                                        {runnerProfitsDisplayPremium[runner.selectionId] !==
                                                            undefined && (
                                                                <p
                                                                    className={`text-green-400 max-mk:text-[0.65rem] text-[0.75rem] font-bold`}
                                                                >
                                                                    +
                                                                    {parseFloat(
                                                                        runnerProfitsDisplayPremium[
                                                                        runner.selectionId
                                                                        ]
                                                                    ).toFixed(2)}
                                                                </p>
                                                ...
                                                {selectedEventId === null && isLineMarket && (
                                                    <>
                                                        {runnerProfitsDisplayPremium[runner.selectionId] !==
                                                            undefined && (
                                                                <p
                                                                    className={`text-red-400 max-mk:text-[0.65rem] text-[0.75rem] font-bold`}
                                                                >
                                                                    -
                                                                    {parseFloat(
                                                                        runnerProfitsDisplayPremium[
                                            ...
                                            <>
                                                ...
                                                {selectedEventId !== null && (
                                                    <>
                                                        {runnerProfitsDisplay[runner.selectionId] !==
                                                            undefined && (
                                                                <p
                                                                    className={`max-mk:text-[0.65rem] text-[0.75rem] font-bold text-${parseFloat(
                                                                        runnerProfitsDisplay[runner.selectionId]
                                                                    ) >= 0
                                                                            ? "green"
                                                                            : "red"
                                                ...
                                                {selectedEventId === null && (
                                                    <>
                                                        {runnerProfits[runner.selectionId] !==
                                                            undefined && (
                                                                <p
                                                                    className={`max-mk:text-[0.65rem] text-[0.75rem] font-bold text-${parseFloat(
                                                                        runnerProfits[runner.selectionId]
