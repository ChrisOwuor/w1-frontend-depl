          ...
          >
            ...
            {/* <div className="flex text-white items-center gap-x-2 w-full border-b border-gray-900/[0.5] ">
                <p
                  ...
                  } text-white font-bold px-4 py-1.5 cursor-pointer relative`}
                ...
                <p
                  className={`mk:text-[1rem] text-[0.833rem] ${
                    otherMarkets === "fancy" ? "bg-[#DB4E08]" : "bg-[#DB4E08]"
                  } text-black font-bold px-4 py-1.5 cursor-pointer relative`}
