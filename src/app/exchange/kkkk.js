...
const MarketComponent = ({ market, openedd, eventData, setRefresh }) => {
    ...
    useEffect(() => {
        if (market) {
            ...
            runner(mktIds); // Initial fetch
            const intervalId = setInterval(() => runner(mktIds), INTERVAL);
                                ...
                                <div className={`col-span-6 md:col-span-6 lg:col-span-7 flex items-center gap-x-2`}>
                                    ...
                                    <div className="grid grid-cols-6">
                                        <div className="col-span-4">
                                            ...
                                            {selectedEventId && betObj && betObj.marketName === market.marketName && selectedEventId === runner.runnerName ?
                                                betObj.betType === "back" ?
                                                    (
