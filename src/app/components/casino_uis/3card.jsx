...
const Card3Interface = () => {
  ...
  return (
    <>
      ...
      {/* BET SECTION */}
      <div className="mt-2">
        <div className="grid grid-cols-10 gap-x-4 bg-back/[0.5] border border-black">
          <div className="col-span-1 items-center justify-center flex  border-r border-black">
            <p className='text-black font-bold'>YES</p>
          </div>
          <div className="col-span-9 flex justify-around items-center p-10">
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/A.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/2.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/3.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/4.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/5.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/6.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/7.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/8.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/9.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/10.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/J.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/Q.png" className="w-9" />
            <img src="https://versionobj.ecoassetsservice.com/v20/static/front/img/cards/K.png" className="w-9" />
          </div>
        </div>
        <div className="grid grid-cols-10 gap-x-4 bg-lay/[0.5] border border-black">
          <div className="col-span-1 items-center justify-center flex border-r border-black">
      ...
      <div className="relative flex flex-col gap-x-2 mt-2">
        ...
        <div className="flex items-center justify-end p-2">
          <div className="flex gap-x-2  justify-center items-center text-[#FFFF33]">
            <p className="bg-[#355E3B]  px-3 py-1 rounded-full text-md font-medium">R</p>
            <p className="bg-[#355E3B]  px-3 py-1 rounded-full text-md font-medium">R</p>
            <p className="bg-[#355E3B]  px-3 py-1 rounded-full text-md font-medium">R</p>
            <p className="bg-[#355E3B]  px-3 py-1 rounded-full text-md font-medium">R</p>
            <p className="bg-[#355E3B]  px-3 py-1 rounded-full text-md font-medium">R</p>
