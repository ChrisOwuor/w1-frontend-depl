        ...
        <div className="grid grid-cols-12 bg-[#F2F2F2] mt-2">
          ...
          <div className="col-span-9  px-2 border-r-6 border-[#2C3E50]">
            <div className='grid grid-cols-5'>
              ...
              <div className="col-span-2 px-3 py-2 flex justify-center">
                <p className='font-bold text-xl text-black'>
                  {gameData?.t2?.find(item => item.nation === 'Dragon')?.gstatus === "1" ? parseInt(gameData?.t2?.find(item => item.nation === 'Dragon')?.rate) : "0"}
                </p>
              </div>
              <div className="col-span-1 px-3 py-2 border-l border-white/[0.2]  flex justify-center">
                <p className='font-bold text-xl text-black'>
                  {gameData?.t2?.find(item => item.nation === 'Tie')?.gstatus === "1" ? parseInt(gameData?.t2?.find(item => item.nation === 'Tie')?.rate) : "0"}
                </p>
              </div>
              <div className="col-span-2 px-3 py-2 border-l border-white/[0.2]  flex justify-center">
                <p className='font-bold text-xl text-black'>
                  {gameData?.t2?.find(item => item.nation === 'Tiger')?.gstatus === "1" ? parseInt(gameData?.t2?.find(item => item.nation === 'Tiger')?.rate) : "0"}
                </p>
              </div>
            </div>
            ...
            <div className='grid grid-cols-5 gap-x-1'>
              <div className="col-span-2 relative w-full flex justify-center bg-gradient-to-r from-[#0086C9] to-[#2B3F52] border border-gray py-2 rounded-lg"
                onClick={() => handleUserSelection({ data: gameData?.t2?.find(item => item.nation === 'Dragon'), selection: "Dragon" })}
              >
              ...
              <div className="col-span-1 relative w-full flex justify-center bg-gradient-to-r from-[#0086C9] to-[#2B3F52] border border-gray py-2 rounded-lg"
                onClick={() => handleUserSelection({ data: gameData?.t2?.find(item => item.nation === 'Tie'), selection: "Tie" })}
              >
              ...
              <div className="col-span-2 relative w-full flex justify-center bg-gradient-to-r from-[#0086C9] to-[#2B3F52] border border-gray py-2 rounded-lg"
                onClick={() => handleUserSelection({ data: gameData?.t2?.find(item => item.nation === 'Tiger'), selection: "Tiger" })}
              >
          ...
          <div className="col-span-3 px-2">
            <div className='grid grid-cols-1'>
              ...
              <div className="col-span-1 px-3 py-2 border-l border-white/[0.2]  flex justify-center">
                <p className='font-bold text-xl text-black'>
                  {gameData?.t2?.find(item => item.nation === 'Pair')?.gstatus === "1" ? parseInt(gameData?.t2?.find(item => item.nation === 'Pair')?.rate) : "0"}
                </p>
              </div>
            </div>
            <div className='grid grid-cols-1'>
              <div className="col-span-1 relative w-full flex justify-center bg-gradient-to-r from-[#0086C9] to-[#2B3F52] border border-gray py-2 rounded-lg"
                onClick={() => handleUserSelection({ data: gameData?.t2?.find(item => item.nation === 'Pair'), selection: "Pair" })}
              >
