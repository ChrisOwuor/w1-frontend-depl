    ...
    return (
        <div className="grid grid-cols-5">
            <div className="col-span-5 grid grid-cols-5">
                <div className=""></div>
                <div className=""></div>
                <div className="text-transparent rounded-t-full pt-4 -mb-5" style={{ backgroundColor: globalSettings?.topBarBgColor || "#1F3340" }}>o</div>
                <div className=""></div>
                <div className=""></div>
            </div>

            <div className="grid grid-cols-5 col-span-5 relative px-4 w-full gap-x-1 items-center" style={{ backgroundColor: globalSettings?.topBarBgColor || "#1F3340" }}>
